...
int main() {
    ...
    const char* filename = "data/test_base_temp.txt";
    ...
    {   
        BaseFile writeFile(filename, "w+");
        size_t totalWritten = 0;
        
        while (totalWritten < DATA_SIZE) {            
            size_t written = writeFile.write(originalData + totalWritten, 256);
